#!/usr/bin/env python3
"""
Aggressive cleanup script that handles circular foreign key dependencies.
"""
...
def main():
    print("🔥 Aggressive cleanup with circular dependency handling...")
    ...
    try:
        ...
        for company_id, name, email in companies_to_delete:
            try:
                ...
                # 7. Delete business relationships
