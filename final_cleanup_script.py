#!/usr/bin/env python3
"""
Final cleanup script that handles the remaining circular foreign key dependencies.
"""
...
def main():
    print("🎯 Final cleanup - handling remaining circular dependencies...")
    ...
    try:
        ...
        for company_id, name, email in companies_to_delete:
            try:
                # Handle circular dependencies by temporarily disabling foreign key checks
                # and deleting in the correct order
