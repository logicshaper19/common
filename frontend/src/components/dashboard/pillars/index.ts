/**
 * Four-Pillar Dashboard Components
 * Reusable components for the four pillars of supply chain management
 */

export { default as IncomingOrdersCard } from './IncomingOrdersCard';
